...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch_len', type=int, default=64,
    ...
    # Model params
    parser.add_argument('--model_type', type=str, default='blstm',
    ...
    # Saving and loading model params:./saved_models/100hr_60epochs.h5
    parser.add_argument('--model_save', type=str,default='./saved_models/100hr_60epochs_blstm_2.h5',
                        help='Path, where to save model.')
    parser.add_argument('--checkpoint', type=int, default=10,
                        help='No. of epochs before save during training.')
    parser.add_argument('--model_load', type=str, default='./saved_models/100hr_60epochs_blstm_1.h5',
